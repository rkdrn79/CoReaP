...
class ImageFolderMaskDataset_512_VAL(Dataset):
    def __init__(self,
    ...
    def _load_mask(self, mpath='/home/work/research/CoReaP/data/masks_val_512_eval'):
    ...
    def _load_resized_image(self, raw_idx, res=512):
            fname = self._image_fnames[raw_idx]
            with self._open_file(fname) as f:
                if pyspng is not None and self._file_ext(fname) == '.png':
                    image = pyspng.load(f.read())
